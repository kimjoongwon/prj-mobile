...
Story names should clearly describe the scenario being demonstrated. The Plate application uses Korean naming conventions in the provided examples (e.g., "변형_전체", "크기_전체"), but English names would follow a similar pattern (e.g., "All Variants", "All Sizes").
